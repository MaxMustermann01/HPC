#ifndef _TRANSMITBUFFER_2D_H_
#define _TRANSMITBUFFER_2D_H_
...
class TransmitBuffer_2D {
  ...
  public:
    explicit Buffers() {
      ...
      std::fill(&m_buffers[0], &m_buffers[8], nullptr);
...
private:
  ...
  const Proc_Grid_2D_t* m_proc_grid;
...
public:
  ...
  TransmitBuffer_2D(Proc_Grid_2D_t* _pg) : m_proc_grid(_pg), m_send_buffers(), m_recv_buffers()
  {}
